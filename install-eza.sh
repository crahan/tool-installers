...
case "${OS}" in
  Linux)
    ...
    ;;
  Darwin)
    echo "No prebuilt macOS binaries available. Install via Homebrew instead: brew install eza" >&2
    exit 1
    ;;
  *) echo "Unsupported OS: ${OS}" >&2; exit 1 ;;
esac

echo "Installing eza from ${REPO}..."
...
# Download and extract eza binary directly to install directory
