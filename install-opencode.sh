...
echo "Installing OpenCode from ${REPO}..."
...
DOWNLOAD_URL="https://github.com/${REPO}/releases/download/${LATEST_TAG}/opencode-${PLATFORM}.${EXT}"
...
# Download and extract opencode binary directly to install directory
if [ "${EXT}" = "tar.gz" ]; then
...
echo "OpenCode ${LATEST_TAG} installed to ${INSTALL_DIR}/${APP_NAME}"
